...
VBoxManage modifyvm $vmname --nic1 bridged --bridgeadapter1 "Ethernet"
...
VBoxManage storageattach $vmname --storagectl "IDE Controller" --port 0 --device 0 --type dvddrive --medium "D:\2024sem2\Cybersecurity\vdi's\SW_DVD9_Win_Pro_10_20H2.10_64BIT_English_Pro_Ent_EDU_N_MLF_X22-76585.ISO"