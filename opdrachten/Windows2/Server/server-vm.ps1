...
VBoxManage storageattach $vmname --storagectl "SATA Controller" --port 1 --device 0 --type dvddrive --medium "C:\Users\julie\SEP\sep2324-gent-g06\opdrachten\Windows\Server\en-us_windows_server_2022_x64_dvd_620d7eac.iso"